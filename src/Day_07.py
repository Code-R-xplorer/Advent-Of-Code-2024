...
def check_operations_concatenation(input_list):
    true_expressions = []
    ...
    for test_value, numbers in input_list:
        ...
        def evaluate_expression(index, current_value):
            ...
            if evaluate_expression(index + 1, int(str(current_value) + str(numbers[index]))):
                return True
...
print(f"Part 2: {sum(check_operations_concatenation(values))}")
